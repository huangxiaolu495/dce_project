  ...
  jQuery.fn.extend({
    showCalendar: function (options) {
      ...
      var Calendar = {
        ...
        innerHTML: function () {
          var htmlContent = {};
          htmlContent = "<div class='cal_head'>" +
        ...
        styleLoader: function () {
          ...
          $calHead.css({
            "height": lineHeight + 2 * settings.spaceWidth,
          ...
          $operDate.find(".year_sub,.month_sub")
            .css({
              "float": "left",
              "border-right": settings.innerBorder
            });
          $operDate.find(".year_add,.month_add")
            .css({
              "float": "right",
              "border-left": settings.innerBorder
            });
          $operDate.find("span")
            .css({
              "color": settings.ymFontColor,
          ...
          $calBottom.css({
            "margin-right": settings.spaceWidth
          });
          $calBottom.find("button")
            .css({
              "border": settings.btnBorder,
          ...
          //去除button链接的虚线框  
          $("." + settings.className + " button").focus(function () {
            this.blur()
          });
          ...
          $calBottom.find("button").hover(function () {
            $(this).css({
              "background": settings.btnHoverBgColor,
              "color": settings.btnHoverFontColor
            });
          }, function () {
            $(this).css({
              "background": settings.btnBgColor,
        ...
        dateEvent: function () {
          ...
          $calendar.find(".year_add").click(function () {
            Calendar.yearAdd();
          });
          $calendar.find(".year_sub").click(function () {
            Calendar.yearSub();
          });
          $calendar.find(".month_add").click(function () {
            Calendar.monthAdd();
          });
          $calendar.find(".month_sub").click(function () {
            Calendar.monthSub();
          });
          $calendar.find(".confirm_date").click(function () {
            Calendar.confirm();
          });
          $calendar.find(".today_date").click(function () {
            Calendar.getToday();
          });
          $calendar.find(".clear_date").click(function () {
            Calendar.clear();
          });
        },
        //当前日期:年份和月份  
        ...
        tableStyle: function () {
          ...
          $calTable.find(".week_head td")
            .css({
              "background": settings.weekBgColor,
              "cursor": "auto",
              "border": "0",
          ...
          //去除最右侧表格的右边框  
          $calTable.find("td:nth-child(7n)").css({
            "border-right": 0
          });
