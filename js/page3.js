...
function init() {
  ...
  //所有品种
  var url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_type?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date;
...
//用户名排行榜
function username() {
  var url = 'http://172.52.29.100:10002/dce/group_info/grp_last3m_member_qty?group_id=' + number + '&trade_date=' + trade_date;
  $.ajaxGet(url, function (data) {
...
//进一个月交易总情况
function onechart() {
  var url = 'http://172.52.29.100:10002/dce/group_info/grp_last1m_match_count?group_id=' + number + '&trade_date=' + trade_date;
  $.ajaxGet(url, function (data) {
    if (data.message == 'success') {
      if (data.result.length > 0) {
        var match_qty = 0;
      ...
      var url2 = 'http://172.52.29.100:10002/dce/group_info/grp_last1m_contract_qty?group_id=' + number + '&trade_date=' + trade_date;
      var yAxis = [];
      var data = [];
...
function twochart(type, id) {
  ...
  if (type == undefined && id) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_match_qty?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&contract_id=' + id;
    title = "合约号:";
  } else if (id == undefined && type) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_match_qty?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&type_id=' + type;
    title = "品种:";
  } else if (id == undefined && type == undefined) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_match_qty?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date;
    title = "全部:";
  } else {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_match_qty?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&contract_id=' + id;
    title = "全部:";
...
function threechart(type, id) {
  ...
  var title = "";
  if (type == undefined && id) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_hold_qty?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&contract_id=' + id;
    title = "合约号:";
  } else if (id == undefined && type) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_hold_qty?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&type_id=' + type;
    title = "品种:";
  } else if (id == undefined && type == undefined) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_hold_qty?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date;
    title = "全部:";
  } else {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_hold_qty?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&contract_id=' + id;
    title = "全部:";
...
function fourschart(type, id) {
  ...
  var title = "";
  if (type == undefined && id) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_hold_profit?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&contract_id=' + id;
    title = "合约号:";
  } else if (id == undefined && type) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_hold_profit?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&type_id=' + type;
    title = "品种:";
  } else if (id == undefined && type == undefined) {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_hold_profit?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date;
    title = "全部:";
  } else {
    url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_hold_profit?group_id=' + number + '&trade_date=' + trade_date + '&last_date=' + last_date + '&contract_id=' + id;
    title = "全部:";
...
function cjl() {
  ...
  var url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_mkt_match_qty?group_id=' + number + '&trade_date=' + trade_date;
  $.ajaxGet(url, function (data) {
    if (data.message == 'success') {
      var html = [];
      if (data.result.length > 0) {
...
function wtl() {
  ...
  var url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_mkt_order_qty?group_id=' + number + '&trade_date=' + trade_date;
  $.ajaxGet(url, function (data) {
    if (data.message == 'success') {
      var html = [];
      if (data.result.length > 0) {
...
function ccl() {
  ...
  var url = 'http://172.52.29.100:10002/dce/group_info/grp_daily_mkt_hold_qty?group_id=' + number + '&trade_date=' + trade_date;
  $.ajaxGet(url, function (data) {
    if (data.message == 'success') {
      var html = [];
      if (data.result.length > 0) {
...
$("#title-one").click(function () {
  window.location.href = "transactions.html?type=3" + "&number=" + number + "&trade_date=" + trade_date + "&last_date=" + last_date;
});
...
$("#title-two").click(function () {
  window.location.href = "wordCloud.html?type=3" + "&number=" + number + "&trade_date=" + trade_date;
});